...
export default function Home() {
    ...
    return (
        <>
            <Banner titulo="Lista de Personagens" mensagem="Relembre aqui alguns personagens de STAR WARS" />
            <section id="two" class="wrapper style1 special">
				<div class="inner">
					<header>
						<h2>Personagens</h2>
						<p>Confira aqui alguns dos personagens favoritos segundo os fãs</p>
					</header>
